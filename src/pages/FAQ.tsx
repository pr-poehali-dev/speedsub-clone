...
const faqItems = [
  {
    question: 'Как заказать накрутку?',
    answer: 'Заказать накрутку легко: оплатите услугу, скиньте чек и историю покупок на сайте в наш чат https://t.me/SpeedSub_support/4'
  },
  {
